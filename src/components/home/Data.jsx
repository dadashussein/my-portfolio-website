...
const Data = () => {
  return (
    <div className='home__data'>
      <h1 className='home__title'>Dadash H.
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I am a Frontend Developer experience in React, Redux, JavaScript, HTML, CSS, Bootstrap, Material UI, and React-Bootstrap. I am a self-motivated and hardworking person. I am a quick learner and always ready to learn new things. I am a team player and I can work under pressure.</p>

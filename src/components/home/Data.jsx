  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Hello, I am a frontend developer with a passion for creating beautiful
        and intuitive web experiences. I specialize in HTML, CSS, and JavaScript
        and have extensive experience with frontend technologies like React,
        Redux, Next.js, Tailwind, Bootstrap, and Material UI. With my expertise
        in these technologies, I have built a range of web applications and
        websites that prioritize user experience, accessibility, and
        performance.
      </p>
